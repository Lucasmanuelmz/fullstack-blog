...
export default function LoginPage() {
 ...
 <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  ...
  <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <div>
        <div className="flex items-center justify-between">
          ...
          <div className="text-sm">
            <Link to="#" className="font-semibold text-indigo-600 hover:text-indigo-500">Esqueceu sua senha?</Link>
          </div>
        </div>
        <div className="mt-2">
    ...
    Você ainda não é um membro?
      <Link to="/new-account" className="ml-1 font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Crie uma conta</Link>
    </p>
  </div>
</div>
</>
